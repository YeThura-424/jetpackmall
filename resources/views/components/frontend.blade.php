...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            @guest {{-- checking whether the new user is guest or member --}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href=" {{route('subcategory',$subcategory->id)}} "> {{$subcategory->name}} </a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg bg-light" data-setbg="frontend/img/hero/banner.jpg">
